...
class HZAnalyticsMethodCell(val name: String, val desc: String, val agentName: String) {
    ...
    constructor(name:String, desc:String, parent: String, agentName:String, agentDesc:String,
        paramsStart:Int, paramsCount:Int, opcodes:List<Int>): this(name, desc, agentName) {
        this.parent = parent
    ...
    override fun equals(other: Any?): Boolean {
        if (other is HZAnalyticsMethodCell) {
