...
import com.hzdata.analytics.android.gradle.replaceDotBySlash
...
class HZPackageManager
{
    ...
    private val special = mutableSetOf(
        ...
        //sensorsdata special
        "com.hzdata.analytics.android.sdk.util.SensorsDataUtils",
        "com.hzdata.analytics.android.sdk.advert.oaid.SAOaidHelper",
        "com.hzdata.analytics.android.sdk.SensorsDataAPI",
        "com.hzdata.analytics.android.sdk.SALog",
        "com.hzdata.analytics.android.sdk.jsbridge.AppWebViewInterface",
        "com.hzdata.analytics.android.sdk.visual.WebViewVisualInterface"
    ...
    fun isInstrument(clazzName: String, extension: HZExtension): Boolean {
